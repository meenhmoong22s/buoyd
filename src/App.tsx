...
import { IonApp, IonHeader, IonContent, IonToolbar, IonTitle, IonGrid, IonRow, IonCol, IonItem, IonLabel, IonInput, IonCardContent, IonTextarea, IonText, IonFooter, IonTabs, IonTab, IonTabBar, IonTabButton, IonIcon, } from '@ionic/react';
...
const App: React.FC = () => {
  ...
  let [calulatedNtp, setCalculatedNtp] = useState<number>();
  let show = calulatedNtp;
    ...
    <IonApp>
      ...
      <IonContent className='ion-padding' color=''>
        ...
        <IonGrid>
          ...
          <BmiControls onCalculate={calulateNTP} onReset={resetInput}></BmiControls>
